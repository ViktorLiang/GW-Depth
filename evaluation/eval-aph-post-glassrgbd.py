...
def main():
    ...
    inames = sorted(glob.glob("/home/ly/data/datasets/trans-depth/Glass-RGBD/split_images/eval/*.png"))
    gts = sorted(glob.glob("/home/ly/data/datasets/trans-depth/Glass-RGBD/lines_npz/eval/*.npz"))
