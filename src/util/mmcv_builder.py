...
from util.misc import collate_fn_aux
...
def build_parallel_model(args, model, distributed=False):
    # put model on gpus
    if distributed:
        ...
        model = MMDataParallel(
            model.cuda(args.gpu_ids[0]), device_ids=args.gpu_ids)
    return model
